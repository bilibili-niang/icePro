import{P as v}from"./preview-e981285a.js";import{l as x}from"./logo-d4fec688.js";import{a as o,o as u,b as f,f as t,w as c,g as s,d as g,u as k,F as p,r as j,C as B,D as C,t as N}from"./index-c04fac71.js";const b=e=>{e.__sourceCodeTitle="头像",e.__sourceCode=`<div class="ice-column">\r
...
const fits = reactive(['fill', 'contain', 'cover', 'none', 'scale-down'])`},D={class:"ice-row"},F="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg",y={__name:"avatar.fit.preview",setup(e){const i=B(["fill","contain","cover","none","scale-down"]);return(r,n)=>{const l=o("iceTag"),a=o("ice-text"),_=o("ice-avatar"),m=o("container");return u(),f(p,null,[t(a,null,{default:c(()=>[n[1]||(n[1]=s(" 使用 ")),t(l,null,{default:c(()=>n[0]||(n[0]=[s("fit")])),_:1}),n[2]||(n[2]=s(" 控制显示的图片 "))]),_:1}),t(m,null,{default:c(()=>[g("div",D,[(u(!0),f(p,null,C(i,d=>(u(),f("div",{key:d,class:"ice-column"},[t(_,{fit:d,src:F,block:"",size:"120"},null,8,["fit"]),t(a,null,{default:c(()=>[s(N(d),1)]),_:2},1024)]))),128))])]),_:1})],64)}}};typeof T=="function"&&T(y);const S={__name:"index",setup(e){return(i,r)=>(u(),f(p,null,[t(v,{component:U}),t(v,{component:$}),t(v,{component:y})],64))}};export{S as default};
