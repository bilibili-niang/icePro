import{r as e,o as x,c as _,a as h,b as r,w as o,d as c,P as d,F as m}from"./index-c6aa0d5d.js";import{P as a}from"./preview-25ff2814.js";function p(t){return t.__sourceCode=`<container>\r
...
<\/script>`,t}const P={class:"ice-column"},I={__name:"menu.nofold.preview",setup(t){const s=[{text:"基础组件",children:[{text:"button 按钮",href:"/doc/button"},{text:"colors 颜色",href:"/doc/button/colors"},{text:"tools 工具",href:"/doc/tools"},{text:"card 卡片",href:"/doc/card"},{text:"text 文字",href:"/doc/text"}]},{text:"反馈",children:[{text:"message 消息弹窗",href:"/doc/message"}]},{text:"菜单容器",children:[{text:"导航菜单",href:"/doc/menu"}]},{text:"表单",children:[{text:"输入框",href:"doc/input"}]}];return(u,n)=>{const i=e("ice-tag"),l=e("ice-text"),f=e("container");return x(),_(m,null,[h("div",P,[r(l,null,{default:o(()=>[n[1]||(n[1]=c(" 支持 ")),r(i,null,{default:o(()=>n[0]||(n[0]=[c("nofold")])),_:1}),n[2]||(n[2]=c(" 的传入,是否折叠,默认折叠 "))]),_:1})]),r(f,null,{default:o(()=>[r(d,{list:s,nofold:""})]),_:1})],64)}}};typeof v=="function"&&v(I);function $(t){return t.__sourceCode=`<container>\r
...
<\/script>`,t}const V={class:"ice-column"},M={__name:"menu.colors.preview",setup(t){const s=[{text:"基础组件",children:[{text:"button 按钮"},{text:"colors 颜色"},{text:"tools 工具"},{text:"card 卡片"},{text:"text 文字"}]},{text:"反馈",children:[{text:"message 消息弹窗"}]},{text:"菜单容器",children:[{text:"导航菜单"}]}];return(u,n)=>{const i=e("ice-tag"),l=e("ice-text"),f=e("container");return x(),_(m,null,[h("div",V,[r(l,null,{default:o(()=>[n[1]||(n[1]=c(" 支持 ")),r(i,null,{default:o(()=>n[0]||(n[0]=[c("color")])),_:1}),n[2]||(n[2]=c(" 的传入,还有bug,你不要在一个组件里用多个color变量 "))]),_:1})]),r(f,null,{default:o(()=>[r(d,{list:s,color:"muguahuang"}),r(d,{list:s,color:"jiguanghong"})]),_:1})],64)}}};typeof $=="function"&&$(M);const D={__name:"index",setup(t){return(s,u)=>{const n=e("ice-text");return x(),_(m,null,[r(a,{component:w}),r(a,{component:y}),r(a,{component:k}),r(a,{component:I}),r(a,{component:M}),r(n,null,{default:o(()=>u[0]||(u[0]=[c(" 当然也支持横向导航栏 ")])),_:1})],64)}}};export{D as default};
